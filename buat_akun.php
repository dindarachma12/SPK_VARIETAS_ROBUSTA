...
<head>
    ...
    <style>
        ...
        .btn-daftar:hover { background: var(--robusta-brown-dark); color:#fff; }
                ...
                <div class="auth-card">
                    ...
                    if ($validasi == "sukses") {
                        ...
                        <div class='alert alert-success alert-dismissible fade show mb-3' role='alert'>
                            Berhasil, Silahkan masuk menggunakan akun Anda!
                    ...
                    <form action="proses.php" method="post" class="mt-3">
                        <div class="mb-3">
                            ...
                            <input name="nama" class="form-control" id="inputEmail" type="text" placeholder="Masukkan nama lengkap Anda" pattern="[A-Za-z]+( [A-Za-z]+)*" title="Inputan hanya berupa huruf" required autocomplete="off" />
                        </div>

                        <div class="mb-3">
                            <label for="inputEmail" class="form-label">Username</label>
                            <input name="user" class="form-control" id="inputEmail" type="text" placeholder="Buat username Anda" pattern="[A-Za-z0-9]+" title="Inputan hanya boleh huruf dan angka" minlength="5" required autocomplete="off" />
                        </div>

                        <div class="mb-3">
                            <label for="inputPassword" class="form-label">Sandi</label>
                            <input name="pass" class="form-control" id="inputPassword" type="password" placeholder="Buat sandi Anda" pattern="[^&#34;&#39;&#60;&#62;]+" minlength="5" required autocomplete="off" />
                        </div>

                        <div class="mb-3">
                            <label for="inputPassword" class="form-label">Konfirmasi Sandi</label>
                            <input name="konfir" class="form-control" id="inputPassword" type="password" placeholder="Konfirmasi sandi Anda" pattern="[^&#34;&#39;&#60;&#62;]+" minlength="5" required autocomplete="off" />
                        </div>

                        <div class="d-grid">
                            <button name="daftar_akun" class="btn btn-primary">Daftar</button>
                        </div>
                    </form>

                    <div class="auth-footer text-center mt-4">
                        <div>Sudah punya akun? <a href="masuk.php">Masuk Akun</a></div>
                    </div>
                </div>
            </div>
